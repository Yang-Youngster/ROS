...
if("TRUE" STREQUAL "TRUE")
  set(kr_trackers_SOURCE_PREFIX /home/luoyang/文档/GitHub/ROS/test_path/src/trackers/kr_trackers)
  set(kr_trackers_DEVEL_PREFIX /home/luoyang/文档/GitHub/ROS/test_path/devel)
  ...
  set(kr_trackers_INSTALL_PREFIX /home/luoyang/文档/GitHub/ROS/test_path/install)
...
if(NOT "/home/luoyang/文档/GitHub/ROS/test_path/src/trackers/kr_trackers/include;/usr/include/eigen3 " STREQUAL " ")
  set(kr_trackers_INCLUDE_DIRS "")
  set(_include_dirs "/home/luoyang/文档/GitHub/ROS/test_path/src/trackers/kr_trackers/include;/usr/include/eigen3")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'kr_trackers' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/luoyang/文档/GitHub/ROS/test_path/src/trackers/kr_trackers/${idir}'.  ${_report}")
    endif()
...
set(depends "actionlib;std_msgs;geometry_msgs;nav_msgs;tf;quadrotor_msgs;kr_tracker_msgs;kr_trackers_manager")
