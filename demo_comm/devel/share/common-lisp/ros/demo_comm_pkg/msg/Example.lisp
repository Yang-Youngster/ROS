...
(cl:in-package demo_comm_pkg-msg)
...
(cl:defmethod cl:initialize-instance :after ((m <Example>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Example)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name demo_comm_pkg-msg:<Example> is deprecated: use demo_comm_pkg-msg:Example instead.")))

(cl:ensure-generic-function 'name-val :lambda-list '(m))
(cl:defmethod name-val ((m <Example>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader demo_comm_pkg-msg:name-val is deprecated.  Use demo_comm_pkg-msg:name instead.")
  (name m))

(cl:ensure-generic-function 'age-val :lambda-list '(m))
(cl:defmethod age-val ((m <Example>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader demo_comm_pkg-msg:age-val is deprecated.  Use demo_comm_pkg-msg:age instead.")
  (age m))

(cl:ensure-generic-function 'height-val :lambda-list '(m))
(cl:defmethod height-val ((m <Example>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader demo_comm_pkg-msg:height-val is deprecated.  Use demo_comm_pkg-msg:height instead.")
  (height m))
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<Example>)))
  ...
  (cl:format cl:nil "#传统的通信信息不满足上面的要求，其中通信的数据需要自定义~%string name ~%uint16 age~%float64 height~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'Example)))
  "Returns full string definition for message of type 'Example"
  (cl:format cl:nil "#传统的通信信息不满足上面的要求，其中通信的数据需要自定义~%string name ~%uint16 age~%float64 height~%~%"))
