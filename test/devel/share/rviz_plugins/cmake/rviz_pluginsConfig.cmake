...
if("TRUE" STREQUAL "TRUE")
  set(rviz_plugins_SOURCE_PREFIX /home/luoyang/桌面/ROS/test/src/Fast-Planner/uav_simulator/Utils/rviz_plugins)
  set(rviz_plugins_DEVEL_PREFIX /home/luoyang/桌面/ROS/test/devel)
  ...
  set(rviz_plugins_INSTALL_PREFIX /home/luoyang/桌面/ROS/test/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'rviz_plugins' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/luoyang/桌面/ROS/test/src/Fast-Planner/uav_simulator/Utils/rviz_plugins/${idir}'.  ${_report}")
    endif()
